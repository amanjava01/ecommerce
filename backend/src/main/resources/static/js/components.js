...
function createProductCard(product) {
    ...
    const imageUrl = product.mainImageUrl || '/uploads/placeholder.svg';
    ...
    card.innerHTML = `
        <div class="product-image">
            <img src="${imageUrl}" alt="${product.name}" onerror="this.src='/uploads/placeholder.svg'">
        </div>
...
function createOrderItem(item) {
    ...
    orderItem.innerHTML = `
        <div class="item-image">
            <img src="${item.product?.mainImageUrl || '/uploads/placeholder.svg'}" 
                 alt="${item.name}">
        </div>
